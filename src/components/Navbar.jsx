...
const Navbar = () => {
  ...
  useEffect(()=>{
    if(showMobileMenu){
      document.body.style.overflow='hidden' //matlb ki jab ham mobile khole scrolling stop ho jae 
    }else{
  ...
  return (
    <div className='absolute top-0 left-0 w-full z-10'>
        ...
        <ul className='hidden md:flex gap-7 text-white'> 
            ...
            <a href="#Teastimonials" className='cursor-pointer hover:text-gray-400'>Testimonials</a>
        </ul>
